...
GeneDetail.prototype.update = function(node_object_array, tf_object){
    ...
    var chart_url = self.networkDetail.goUrlMaker(node_object_array.go, self.networkDetail.chart_url_prefix);
...
GeneDetail.prototype.visualize = function(node_detail_array, gene_id_to_name_array){
 ...
 //  // create data links
 //  var chart_url = self.networkDetail.goUrlMaker(gene_cluster_array, self.networkDetail.chart_url_prefix);
